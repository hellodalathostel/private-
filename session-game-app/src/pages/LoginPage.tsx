...
export function LoginPage() {
  ...
  return <div className="login-page"><section className="login-card">
    ...
    {!hasSupabaseConfig ? <div className="notice warning">Chưa cấu hình Supabase. Sao chép <code>.env.example</code> thành <code>.env.local</code> và điền anon key.</div> : null}
